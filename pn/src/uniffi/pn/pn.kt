...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_pn_ed7b_rustbuffer_alloc(size, status).also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_pn_ed7b_rustbuffer_free(buf, status)
        }

        internal fun reserve(buf: RustBuffer.ByValue, additional: Int) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_pn_ed7b_rustbuffer_reserve(buf, additional, status)
        }
    }
...
internal interface _UniFFILib : Library {
    companion object {
        internal val INSTANCE: _UniFFILib by lazy {
            loadIndirect<_UniFFILib>(componentName = "pn")
        }
    }

    fun pn_ed7b_get_backtrace(
        uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_pn_ed7b_rustbuffer_alloc(
        size: Int,
        uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_pn_ed7b_rustbuffer_from_bytes(
        bytes: ForeignBytes.ByValue,
        uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_pn_ed7b_rustbuffer_free(
        buf: RustBuffer.ByValue,
        uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_pn_ed7b_rustbuffer_reserve(
        buf: RustBuffer.ByValue,
        additional: Int,
        uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
fun getBacktrace(): String {
    val _retval =
        rustCall() { status ->
            _UniFFILib.INSTANCE.pn_ed7b_get_backtrace(status)
        }
